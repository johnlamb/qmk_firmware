...
[_QWERTY] = LAYOUT_plaid_grid(
    ...
    LCTL_T(KC_ESC), KC_A,                KC_S,    KC_D,    KC_F,  KC_G,              KC_H,   KC_J,   KC_K,    KC_L,    LT(NAV, KC_SCLN), KC_QUOT,
    KC_LSFT,        KC_Z,                KC_X,    KC_C,    KC_V,  KC_B,              KC_N,   KC_M,   KC_COMM, KC_DOT,  KC_SLSH,          RCTL_T(KC_ENT),
...
[_RAISE] = LAYOUT_plaid_grid(
    ...
    _______, _______, _______, _______, _______, KC_LCBR, KC_RCBR, _______, _______, _______, _______, KC_VOLU,
    _______, _______, _______, _______, KC_LBRC, KC_LPRN, KC_RPRN, KC_RBRC, _______, _______, KC_BSLS, KC_VOLD,
...
[_LOWER] = LAYOUT_plaid_grid(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   SE_OE,   SE_AE,
