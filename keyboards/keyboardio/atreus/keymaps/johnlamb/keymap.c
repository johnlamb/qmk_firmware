...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QW] = LAYOUT( /* Qwerty */
    ...
    LCAG_T(KC_ESC),  KC_TAB,  KC_LGUI, KC_LSFT, KC_BSPC, KC_LCTL, KC_LALT, LT(_LW, KC_SPC),  MO(_RS), KC_MINS, KC_QUOT, KC_ENT
  ),
  ...
  [_RS] = LAYOUT( /* [> RAISE <] */
    ...
    _______, _______, _______, _______, KC_LBRC, KC_LPRN, KC_RPRN,KC_RBRC, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT,
